...
function add_subdomain() {
    ...
    for sub in "${ADDR[@]}"; do
        ...
        wget https://raw.githubusercontent.com/Mrian07/ubuntu24/main/install/subdomain-lion.sh -O /tmp/subdomain-lion.sh
        chmod +x /tmp/subdomain-lion.sh

        # Jalankan skrip rmbl.sh dengan animasi
        /tmp/subdomain-lion.sh &
        show_spinner $!
...
clear;clear;clear
echo -e " $COLOR1╭════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│ ${WH}               • SCRIPT BY LIONSSH-TEAM •              ${NC} $COLOR1│$NC"
echo -e " $COLOR1╰════════════════════════════════════════════════════════╯${NC}"
echo -e " $COLOR1      ══════════════════════════════════════════════${NC}"
