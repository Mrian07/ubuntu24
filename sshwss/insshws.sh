...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/Mrian07/ubuntu24/main/sshwss/ws-dropbear
...
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Mrian07/ubuntu24/main/sshwss/ws-stunnel
