...
# Ganti Banner
wget -O /etc/issue.net "https://raw.githubusercontent.com/Mrian07/aingman-script/main/menu/issue.net"
...
# download script
cd /usr/bin
wget -O issue "https://raw.githubusercontent.com/Mrian07/aingman-script/main/menu/issue.net"
