...
IPVPS=$(curl -sS https://raw.githubusercontent.com/Mrian07/izinsc/main/ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP != $IPVPS ]]; then
domain
Casper2
#botwa
...
#mkdir /root/casper
#cd /root/casper
#wget https://raw.githubusercontent.com/Mrian07/izinsc/main/ip >/dev/null 2>&1
...
res1() {
wget https://raw.githubusercontent.com/Mrian07/ubuntu24/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
...
echo -e  "${BIBlue}│                \033[1;37m PAKETSSH.COM              ${BIBlue}│${NC}"
echo -e  "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo " "
...
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/Mrian07/ubuntu24/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
...
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/Mrian07/ubuntu24/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/Mrian07/ubuntu24/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/Mrian07/izinsc/main/ip | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
